...
OBJ := src/errnor.o src/assert_.o src/string.o src/strings.o src/malloc.o src/plat_version.o src/syscaller.o src/unistd.o src/fcntl.o src/sys_mman.o $($(PLAT)_OBJ)
